...
public class LetterSubstitutionCipher extends ConsoleProgram {
	...
	/**
	 * Reads an encryption key from the user and checks it for legality (see
	 * isLegalKey below). If the user enters an illegal key, the user is asked
	 * to reenter a valid one.
	 */
	...
	/**
	 * Checks to see whether a key is legal, which means it meets the following
	 * conditions: (1) It is 26 characters long, (2) It contains only uppercase
	 * letters, and (3) It has no duplicated letters.
	 */
