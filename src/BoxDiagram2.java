...
/**
 * This program allows the user to create a set of boxes with labels and then
 * drag them around in the window.
 */
public class BoxDiagram2 extends GraphicsProgram {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (currentObject != null && e.getClickCount() == 2) {
			remove(currentObject);
			// contents.remove(currentObject);
		}
	}
