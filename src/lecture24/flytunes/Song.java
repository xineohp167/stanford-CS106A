...
public class Song {
	/**
	 * Constructor Note that the song name and band name are immutable once the
	 * song is created.
	 */
	...
	/**
	 * Returns a string representation of a song, listing the song name, the
	 * band name, and its price.
	 */
