package lecture24.flightPlanner;
...
public class FlightPlanner extends ConsoleProgram {
	...
	/**
	 * Prints a list of cities from the array list. Each city name is indented
	 * by a space.
	 */
	...
	/**
	 * Reads in the city information from the given file storing the information
	 * in both the ArrayList of cities and the HashMap of flights.
	 */
	...
	/**
	 * Reads a single flight entry from the line passed as an argument, which
	...
	/**
	 * Defines a city if it has not already been defined. Defining a city
	 * consists of entering it in the cities array and entering an empty
	 * ArrayList in the flights table to show that it has no destinations yet.
	 */
